...
- Panel UI: soul dropdown race condition fixed — `__HERMES__` selection now persists on reload
- Long-term memory (Hindsight/PostgreSQL): process startup fixed; ICU library compatibility symlinks added; auto-start systemd service created
