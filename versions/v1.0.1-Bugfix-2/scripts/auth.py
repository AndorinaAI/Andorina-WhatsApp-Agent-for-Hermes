...
saving them directly to ~/.hermes/.env
"""
...
def save_tokens(access_token, refresh_token):
    try:
        ...
        print("\n✅ Tokens saved successfully to ~/.hermes/.env")
...
def main():
    ...
    if not client_id or not client_secret:
        print("❌ Missing GOOGLE_CONTACTS_CLIENT_ID and/or GOOGLE_CONTACTS_CLIENT_SECRET in ~/.hermes/.env")
