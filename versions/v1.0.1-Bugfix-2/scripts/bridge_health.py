...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Ultimate version with zombie cleaning, binary validation and smart backoff.
"""
...
STAMP_PATH  = Path.home() / ".hermes" / ".andorina_bridge_patched"
...
def apply_repair():
    ...
    if not check_qdrant(retries=1):
        ...
        if q_bin.exists():
            ...
            subprocess.Popen([str(q_bin)], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
            time.sleep(4) 
    ...
    if BRIDGE_PATH.exists():
        try:
            ...
            if "app.get('/health'" not in content:
                health_code = "\napp.get('/health', (req, res) => { res.json({ status: connectionState, uptime: process.uptime(), version: '1.0.1-Bugfix-2' }); });\n"
    ...
    try:
        ...
        # Kill everything on detected port
        ...
        time.sleep(1)
        subprocess.run(["hermes", "gateway", "start"], capture_output=True)
