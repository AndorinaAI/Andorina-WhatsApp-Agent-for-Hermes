...
🚀 Andoriña — Ultimate Setup Assistant (v1.0.1-Bugfix-2)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
def main():
    print("🚀 Andoriña Setup v1.0.1-Bugfix-2 (Hardened Edition)\n")
    env = read_env()
    updates = {}
    ...
    try:
        ...
        subprocess.run(["hermes", "hooks", "add", "wa_inbox_alt", "--command", f"python3 '{hook}'", "--event", "whatsapp:message"], capture_output=True)
