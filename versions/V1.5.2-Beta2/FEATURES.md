# 🌟 Andoriña v1.5.2-Beta2 — Complete Feature Reference
## 🇬🇧 English | 🇪🇸 Español
...
## 🔧 What's New in v1.5.2-Beta2 (Bug Fix Release)
## 🔧 Novedades en v1.5.2-Beta2 (Versión de Corrección de Errores)
...
- **Beta-Safe Parsing:** Uses semantic regex to parse version tags like `1.5.2-Beta2` — non-numeric suffixes never break the comparison.
...
- **Soporte de Etiquetas Beta:** Usa regex semántico para parsear versiones como `1.5.2-Beta2` sin errores.
