...
DEFAULT_CID = "234411781437-33o7f79beii28ehqqo7qrdl1tos7a9v3.apps.googleusercontent.com"
DEFAULT_SEC = "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"
...
def main():
    ...
    try:
        httpd.timeout = 300  # 5 minute timeout per request
